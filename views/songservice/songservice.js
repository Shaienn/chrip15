...
(function (App) {
    'use strict';
    var log = require('intel').getLogger('App.View.SongService.Root');
    var self;
	...
	initialize: function () {
	    ...
	    _.each(self.regionManager._regions, function (element, index) {
